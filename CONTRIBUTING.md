...
- [Code Contribution Workflow](#code-contribution-workflow)
  ...
  - [Step 4: Write Code and Tests](#step-5-write-code-to-pass-the-tests)
  - [Step 5: Run All Tests](#step-6-run-all-tests-and-linters)
  - [Step 6: Submit a Pull Request](#step-7-submit-a-pull-request)
...
2.  **Clone your fork** to your local machine:
    ```bash
    git clone https://github.com/HakAl/llm_agent_team.git
    cd llm-agent-team
    ```
