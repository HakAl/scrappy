...
from src.platform.protocols.execution import CommandExecutorProtocol, ExecutionResult
from src.platform.protocols.detection import PlatformDetectorProtocol
from src.platform.protocols.translation import CommandTranslatorProtocol
from src.platform.protocols.fallback import PythonCommandFallbackProtocol
