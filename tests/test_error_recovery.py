...
class TestJSONParsingRecovery:
    """Tests for JSON parsing error recovery."""
    ...
    def test_handles_invalid_json(self):
        ...
        for invalid in invalid_jsons:
            try:
                ...
                assert False, f"Should have failed: {invalid}"
    ...
    @pytest.mark.unit
    def test_json_recovery_with_fallback(self):
...
class TestNetworkErrorRecovery:
    """Tests for network error recovery scenarios."""
    ...
    def test_handles_connection_timeout(self):
        ...
        # Simulate timeout
        mock_provider = Mock()
        mock_provider.chat.side_effect = TimeoutError("Connection timed out")

        try:
            mock_provider.chat([{"role": "user", "content": "test"}])
        except TimeoutError:
    ...
    def test_handles_connection_refused(self):
        ...
        mock_provider = Mock()
        mock_provider.chat.side_effect = ConnectionRefusedError("Connection refused")
    ...
    def test_retry_on_transient_error(self):
        ...
        def flaky_call(*args):
            ...
            return LLMResponse("Success", "model", "provider")

        mock_provider.chat.side_effect = flaky_call
