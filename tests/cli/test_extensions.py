...
class TestLanguageExtensions:
    ...
    def test_python_extensions_contains_py(self):
        ...
        from scrappy.cli.config.extensions import PYTHON_EXTENSIONS
    ...
    def test_javascript_extensions_values(self):
        ...
        from scrappy.cli.config.extensions import JAVASCRIPT_EXTENSIONS
    ...
    def test_web_extensions_values(self):
        ...
        from scrappy.cli.config.extensions import WEB_EXTENSIONS
...
class TestConfigExtensions:
    ...
    def test_config_extensions_values(self):
        ...
        from scrappy.cli.config.extensions import CONFIG_EXTENSIONS
...
class TestDocExtensions:
    ...
    def test_docs_extensions_values(self):
        ...
        from scrappy.cli.config.extensions import DOCS_EXTENSIONS
        expected = {'.md', '.rst', '.txt'}
        for ext in expected:
...
class TestExtensionsCategoryMapping:
    ...
    def test_extensions_by_category_keys(self):
        ...
        from scrappy.cli.config.extensions import EXTENSIONS_BY_CATEGORY
...
class TestEntryPointFiles:
    ...
    def test_entry_point_files_values(self):
        ...
        from scrappy.cli.config.extensions import ENTRY_POINT_FILES
...
class TestPriorityFiles:
    ...
    def test_priority_files_contains_readme(self):
        ...
        from scrappy.cli.config.extensions import PRIORITY_FILES
...
class TestDependencyFiles:
    ...
    def test_dependency_files_python(self):
        ...
        from scrappy.cli.config.extensions import DEPENDENCY_FILES
...
class TestConfigurationFiles:
    ...
    def test_configuration_files_values(self):
        ...
        from scrappy.cli.config.extensions import CONFIGURATION_FILES
        expected = {
...
class TestAllCodeExtensions:
    ...
    def test_all_code_extensions_includes_python(self):
        ...
        from scrappy.cli.config.extensions import ALL_CODE_EXTENSIONS
